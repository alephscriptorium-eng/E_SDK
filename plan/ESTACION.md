# ESTACIÓN · calibración del mundo e-sdk (emmanuel-sdk)
...
| param | valor |
| ----- | ----- |
| `MUNDO_RAIZ` / `WORLD_ROOT` | `C:\S_LAB\e-sdk` (checkout principal) |
...
- Ruta canónica: **`C:\S_LAB\vigilancia\e`**
...
WORLD_ROOT=<worktree-o-mundo> OUT_DIR=C:/S_LAB/vigilancia/e ONCE=1 \
  bash .claude/skills/estacion-viva/scripts/watcher-sesion.sh

# Sesión (muere con el padre; PID en OUT_DIR/watcher.pid)
WORLD_ROOT=<worktree-o-mundo> OUT_DIR=C:/S_LAB/vigilancia/e INTERVAL=45 \
  bash .claude/skills/estacion-viva/scripts/watcher-sesion.sh
```

## Relación con VISION / PRACTICAS

Estación = layout operativo del carril e (calibración auditable en plan).
